...
from src.llm.gemini import check_health, gemini_configured, gemini_status
...
def health() -> dict[str, Any]:
    ...
    return {
        ...
        "gemini_status": status,  # "connected" | "unavailable" | "not_configured"
        "gemini_configured": status == "connected",
